<div id="sidebar">
    <div class="box-style2">
        ...
        <div class="entry">
            ...
            ?>
                ...
                <span style="float:right;"><a style="text-decoration:underline" href="<?php echo $this->config->base_url; ?>logout"><?php echo __('Logout'); ?></a></span>
            <?php
            else :
            ?>
                <div style="text-align:center;margin:0 auto;">
                    ...
                    <form id="login_form" method="post" action="<?php echo $this->config->base_url; ?>">
                        <input type="text" name="username" id="login_input" maxlength="10" class="input-main" style="width:182px;" placeholder="<?php echo __('Username'); ?>" value="" />
                    ...
                    <a href="<?php echo $this->config->base_url; ?>lost-password"><?php echo __('Lost Password'); ?>
                        ?</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?php echo $this->config->base_url; ?>registration"><?php echo __('Registration'); ?></a><br />
                </div>
            <?php
            endif;
            ?>
    ...
    <div class="box-style2">
        ...
        <div class="entry">
            <ul class="style4">
                <li class="first"><a href="<?php echo $this->config->base_url; ?>about"><?php echo __('About Server'); ?></a>
                </li>
                <li><a href="<?php echo $this->config->base_url; ?>rules"><?php echo __('Rules'); ?></a></li>
                <li><a href="<?php echo $this->config->config_entry('main|forum_url'); ?>" target="_blank"><?php echo __('Forum'); ?></a></li>
                ...
                <div style="padding-left: 10px;">
                    ...
                    ?>
                        <ul class="style4">
                            ...
                            ?>
                                <li <?php echo $first; ?>><a href="<?php echo $rss['link']; ?>"><?php echo $rss['title']; ?></a></li>
                            <?php
                            endforeach;
                            ?>
                        </ul>
